...
public class ControllerFollowers {
    ...
    String getPhotoForFollowersActor() {
        String img = followerService.getFollowerIMGForActor();
        if (img != null)
            return img;
    ...
    String getPhotoForFollowersAnalyst() {
        String img = followerService.getFollowerIMGForAnalyst();
        if (img != null)
            return img;
        return "Not found photo";
    } 
    ...
    String getPhotoForFollowersStudio() {
        String img = followerService.getFollowerIMGForStudio();
        if (img != null)
            return img;
        return "Not found photo";
    }
